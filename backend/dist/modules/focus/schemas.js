import { z } from "zod";
import { dateSchema, optionalTrimmedStringSchema, timestampSchema, trimmedStringSchema } from "../shared/schemas.js";
...
export const focusRoutineItemUpdateSchema = focusRoutineItemInputSchema.partial().refine((value) => Object.keys(value).length > 0, "At least one focus routine field is required.");
